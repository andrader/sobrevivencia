...
Obtenha um boxplot dos dados e um histograma (com a curva da densidade teórica também no gráfico). Obtenha também a curva de sobrevivência empírica dos dados e coloque num mesmo gráfico a curva empírica e a curva teórica utilizada para gerar os gráficos.
...
Faça um gráfico de quantis ( QQPlot) comparando os quantis empíricos com os quantis teóricos da distribuição Weibull utilizada para gerar os dados.
...
Padronize os dados (ou seja, subtraia a média amostral e divida pelo desvio padrão) e faça um gráfico de quantis ( \$Q Q\$ Plot ) comparando os quantis empíricos da variável padronizada com os da normal padrão. Discuta a adequabilidade da distribuição normal aos dados.
...
Repita os itens (b) e (c) para $n=40, n=300$ e $n=1200$.
